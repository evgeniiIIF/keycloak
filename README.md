...
напиши bash команды для создния папок и файлов с их содержимым, если в файле нужно исправить несколько строк и его полность ненужно переписывать то точерьно измени/добавь только эти строки и непиши код файла целиком.